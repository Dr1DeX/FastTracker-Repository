...
SECRET_KEY = environ.get('SECRET_KEY', '7cftzwj0cxrljfw!njl!i_zi-tfcmu_8bpr6xyxvt_6a5m')
...
RMQ_USER = environ.get('RMQ_USER', 'mirai')
RMQ_PASS = environ.get('RMQ_PASS', 'davog1337')
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': environ.get('POSTGRES_PASSWORD', 'prikol12345ahaha'),
